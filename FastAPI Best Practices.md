...
Second, there's no performance hit either. **FastAPI caches dependencies per request**, your dependency will be evaluated once in a request.  It is efficient and helps to keep your endpoint clean.22
