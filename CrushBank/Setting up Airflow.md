1. Follow this to setup Airflow: https://www.dataquest.io/blog/setting-up-apache-airflow-with-docker-locally-part-i/

2. Setup a virtual environment.

3. Put these in requirements.txt:
...
Inside the `dags/` folder make a `my_first_dag.py`.
...
random.choice(["Science", "Tech", "Weather", "Space", "Finance"])
...
task_id="generate_fake_events", python_callable=generate_fake_events

)

task_transform = PythonOperator(

task_id="transform_and_save_csv", python_callable=transform_and_save_csv
